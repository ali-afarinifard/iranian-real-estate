...
export function createNestifyTheme(mode: PaletteMode) {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontSize: '3rem',    fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em' },
    ...
    components: {
      ...
      MuiAppBar: {
        styleOverrides: {
          root: {
            backgroundColor: isDark ? alpha(NEUTRAL[800], 0.85) : alpha('#FFFFFF', 0.85),
      ...
      MuiSkeleton: {
        styleOverrides: {
          root: {
            borderRadius: 8,
            backgroundColor: isDark ? alpha('#FFFFFF', 0.06) : alpha('#000000', 0.06),
          },
        },
      },
